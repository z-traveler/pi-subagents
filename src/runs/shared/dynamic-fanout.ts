...
const RUNNER_DYNAMIC_PARALLEL_KEYS = new Set([
	...
	"systemPromptMode", "thinking", "modelCandidates", "modelPerformance", "sessionFile", "effectiveAcceptance", "acceptanceInput", "acceptanceRole", "parentSessionId", "launchResolvedExtensions", "requestedCwd",
]);
